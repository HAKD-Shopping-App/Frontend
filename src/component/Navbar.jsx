    ...
    return (
        <div>
            <nav class="navbar navbar-expand-lg bg-light navbar-light bg-light py-3 shadow-sm">
                <div class="container">
                    <a class="navbar-brand fw-bold fs-3" href="http://localhost:3001">HAKD Collection</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="http://localhost:3001/products">Products</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div className="buttons">
                            <a href="http://localhost:3001/auth" className="btn btn-outline-dark me-2">
